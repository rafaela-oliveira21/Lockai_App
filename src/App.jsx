...
export default function App() {
  ...
  // Login: sem caracteres especiais fora do permitido
  ...
  const handleSenhaChange = (e) => {
    ...
    // regex: 8 caracteres, pelo menos 1 maiúscula e 1 especial
      ...
      <div className="w-full max-w-sm bg-primary p-6 rounded-2xl shadow-md">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-terceary text-gray-300 placeholder-gray-400 
        ...
        <div className="mb-2 relative">
          ...
          <input
            ...
            className={`w-full px-3 py-2 bg-terceary text-gray-300 placeholder-gray-400 
                        rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary pr-10
